...
using a topology object (e.g. LinearTopo) from src.mininet.topo or
...
class Mininet(object):
    ...
    def __init__(self, topo=None, switch=OVSKernelSwitch, host=Host,
                 controller=DefaultController, link=None, intf=None,
    ...
    def getNodeByName(self, *args):
        ...
        if len(args) == 1:
            return self.nameToNode.get(str(args[0]))
        return [self.nameToNode.get(str(n)) for n in args]
